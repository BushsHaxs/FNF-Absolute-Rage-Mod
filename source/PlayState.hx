	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'stage':
			{
						defaultCamZoom = 0.9;
						curStage = 'ragestage';
						var bg:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('ragestage/BallisticBackground'));
			  			var bgTex = Paths.getSparrowAtlas('ragestage/BallisticBackground');
						bg.frames = bgTex;
						...
						fire.frames = Paths.getSparrowAtlas('ragestage/fireglow');
						fire.animation.addByPrefix('burn', "FireStage", 24, true);
						fire.animation.play('burn');
						fire.offset.set(300, 0);
						fire.scale.set(2, 2);
						add(fire);

						var table:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('ragestage/glowyfurniture'));
						...
						funnyeffect.antialiasing = true;
						funnyeffect.setGraphicSize(Std.int(funnyeffect.width * 1.1));
